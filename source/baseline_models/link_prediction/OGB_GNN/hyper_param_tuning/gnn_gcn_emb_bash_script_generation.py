...
# define hyperparameter for grid search
hparam_dict = {
    'lr': [1.e-03, 1.e-02, 1.e-04],  # np.logspace(-6, -3, 10),
    'num_layers': [2, 3, 4],
...
log_root = 'final_log_gnn_gcn_emb'
...
scripts_started = 0
with open('final_gnn_gcn_emb_parallelize.sh','w+') as f:
    ...
    for i in range(comb):
        ...
        f.write(f'python gnn.py --use_node_embedding {param_str} &\n')
